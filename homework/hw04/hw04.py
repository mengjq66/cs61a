...
def make_joint(withdraw, old_password, new_password):
    ...
    "Your account is locked. Attempts: ['my', 'secret', 'password']"
    """
    checkOld = withdraw(0, old_password)
    if type(checkOld) == str:
         return checkOld
    def joint(balance, attemptPass):
        if attemptPass == new_password:
            return withdraw(balance, old_password)
        else:
            return withdraw(balance, attemptPass)
    return joint
