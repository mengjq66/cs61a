...
def tscheme_write(str):
    turtle.write(str[1:len(str)-1], True, align="left", font=("Arial", 24, "normal"))

@builtin("write_smaller")
def tscheme_write_smaller(str):
    turtle.write(str[1:len(str)-1], True, align="left", font=("Arial", 20, "normal"))

@builtin("write_small")
def tscheme_write_small(str):
    turtle.write(str[1:len(str)-1], True, align="left", font=("Arial", 15, "normal"))

@builtin("write_bigger")
def tscheme_write_bigger(str):
    turtle.write(str[1:len(str)-1], True, align="left", font=("Arial", 40, "bold"))

@builtin("write_big")
def tscheme_write_big(str):
    turtle.write(str[1:len(str)-1], True, align="left", font = ("Courier", 130, "normal"))

@builtin("write_font")
def tscheme_write_font(str):
    turtle.write(str[1:len(str)-1], True, align="left", font=("Comic Sans MS", 40, "normal"))
